...
| Keymap Viewer / ZMK Studio | USB serial / CDC ACM の ZMK Studio RPC client | ZMK Studio USB serial RPC と unlocked Studio state | Host Link HID とは別経路です。ZMK Studio の BLE transport は対象外です。 |
